...
//=================================================//}
const reply = (teks) => {
return haikal.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `DEVELOPER ʜᴡ ᴍᴏᴅꜱ ᴡᴀ`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/c04cd7a8b0e7cf991d5c1.jpg',"thumbnail": thumb,"sourceUrl": `https://youtube.com/c/HwModsWa857`}}}, { quoted: m})} 
...
if (!isBotAdmins) return m.reply('Bot Bukan Admin Cuy')
let response = await haikal.groupInviteCode(from)
haikal.sendText(from, `https://chat.whatsapp.com/KCYr0YwODJTEEFUlPxuNXQ${response}\n\nLink Group : ${groupMetadata.subject}`, m, { detectLink: true })
}
break
...
//=================================================//
case 'ping': {
haikal.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/c04cd7a8b0e7cf991d5c1.jpg' }, caption: `command : ${prefix}
